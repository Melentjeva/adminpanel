...
<html lang="ru">
<head>
    <title>Добавить новый тип занятия</title>
</head>
<body>
<div class="container">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color: bisque">
        <h1 class="text-center">Добавить новый тип занятия</h1>
    </div>
</div>
<?php
...
if (isset($_POST["Type"])) {
    ...
    if (!empty($_POST["Type"])) {
        if(isNewField($my_link=$link, $column_name='type', $table='raspisanie.lesson_type', $user_data=$type)==true) {
            ...
            $sql = pg_query("INSERT INTO raspisanie.lesson_type (type) VALUES ('" . $type . "')");
