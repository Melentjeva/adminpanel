...
function sendUpdSqlEditAll($link, $group_2,$group_3, $subj,$less_type,$weeks,$hall,$lecturer_1, $lecturer_2, $parity, $id){
        $upd_sql = pg_query($link, "UPDATE raspisanie.schedule SET group_2=" . $group_2 . ", group_3=" . $group_3 . ",
     subject_1=" . $subj . ", lesson_type_1=" . $less_type . ", count_of_weeks_1=" . $weeks . ", hall_1=" . $hall . ",
      lecturer_1_1=" . $lecturer_1 . ", lecturer_1_2=" . $lecturer_2 . ", type_of_week_1=" . $parity . " 
     WHERE id=" . $id . "");
...
function sendUpdSqlEditPair($link,$group_2, $group_3,$subj,$less_type,$weeks,$hall,$lecturer_1, $lecturer_2, $parity, $id){
        $upd_sql = pg_query($link, "UPDATE raspisanie.schedule SET group_2=" . $group_2 . ", group_3=" . $group_3 . ", 
    subject_2=" . $subj . ", lesson_type_2=" . $less_type . ", count_of_weeks_2=" . $weeks . ", hall_2=" . $hall . ", 
    lecturer_2_1=" . $lecturer_1 . ", lecturer_2_2=" . $lecturer_2 . ", type_of_week_2=" . $parity . " 
     WHERE id=" . $id . "");
...
if(isset($_POST['submit']) and isset($_POST['week_radio']))
{
    ...
    if (notEmptyPost()) {
        ...
        elseif ($_GET['lec_row']=='2_1'){
            sendUpdSqlEditPair($link, $gr_2, $gr_3, $subj,$less_type,$weeks,$hall,$lecturer_1, $lecturer_2, $parity, $_GET['id']);
        }
...
function AddBlanksPair($con)
{
    ...
    if (isset($_GET['id']) and !empty($_GET['id'])) {
        ...
        if ($_GET['week'] == 'пар') {
            ...
            if($_GET['lec_row']=='1_1'){
                $lecturer_n_2 = getVars($link, $row, $_GET['lec_row'], '')['5'];
            }
            elseif($_GET['lec_row']=='2_1'){
                $lecturer_n_2 = getVars($link, $row, $_GET['lec_row'], '')['5'];
            }
            ...
            echo '<br><br>';
            sendSelectGroupEdit(' *Группа 1:','Group_1',$link, 'raspisanie.groups', 'group_number', 'isGroupBusyPair', $group_1);
            sendSelectGroupEdit(' Группа 2:','Group_2',$link, 'raspisanie.groups', 'group_number', 'isGroupBusyPair', $group_2);
            sendSelectGroupEdit(' Группа 3:','Group_3',$link, 'raspisanie.groups', 'group_number', 'isGroupBusyPair', $group_3);
            echo '<br><br>';
            ...
            <select name="Lecturer_2">
                <?php
                echo '<option selected="selected">'.$lecturer_n_2.'</option>';
                if (!empty($lecturer_n_2)) {
                    echo '<option></option>';
                }
...
function AddBlanksNotPair($con)
{
    ...
    if (isset($_GET['id']) and !empty($_GET['id'])) {
        ...
        if ($_GET['week'] == 'н/п') {
            ...
            sendSelectEdit(' Число недель:', 'Count_of_Weeks', $link, 'raspisanie.count_of_lessons', 'count', $count_of_weeks);
            echo '<br><br>';
            sendSelectGroupEdit(' *Группа 1:','Group_1',$link, 'raspisanie.groups', 'group_number', 'isGroupBusyNotPair', $group_1);
            sendSelectGroupEdit(' Группа 2:','Group_2',$link, 'raspisanie.groups', 'group_number', 'isGroupBusyNotPair', $group_2);
            sendSelectGroupEdit(' Группа 3:','Group_3',$link, 'raspisanie.groups', 'group_number', 'isGroupBusyNotPair', $group_3);
            echo '<br><br>';
            sendSelectEdit(' *Аудитория:', 'Hall', $link, 'raspisanie.halls', 'hall', $hall);
            ?>
            Преподаватель 2:
